...
import {
    ...
    SCHEDULE_SYNC_ANIME_EN_ALL_EPISODE,
    SCHEDULE_SYNC_ANIME_EN_ALL_ANIME,
...
(async () => {
    try {
        ...
        scheduleUnique.addSchedule(
            ...
            60,
            async function () {
                await messageQueue.send(MQ_SYNC_ANIME_EN_ALL_ANIME, {}, false);
            },
            sendErrorMessage
        );
        ...
        scheduleUnique.addSchedule(
            ...
            60,
            async function () {
                await messageQueue.send(MQ_SYNC_ANIME_EN_ALL_EPISODE, {}, false);
            },
            sendErrorMessage
        );
    } catch (err) {
        await sendErrorMessage('anime-en-schedule-sync', err);
        await timeout(5000);
        process.exit(1);
    }
})();
